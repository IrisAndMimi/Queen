...
//          findViews
        ...
        TextView tvAns0 = (TextView) findViewById(R.id.ans0);
        TextView tvAns1 = (TextView) findViewById(R.id.ans1);
        TextView tvAns2 = (TextView) findViewById(R.id.ans2);
//          get data from Firebase
        ...
        DatabaseReference refAns = firebaseDatabase.getReference("ans");
        refAns.addChildEventListener(new ChildEventListener() {
            @Override
